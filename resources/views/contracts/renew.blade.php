@extends('layouts.app')
@section('title', 'Contratos - Renovar')
@section('css')
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Renovar Contrato Nº {{ $data->correlativo }}</h5>
                    ...
                    <div class="card-body">
                        <form id="formContract" class="needs-validation" action="{{ route('contract.store_renew', $data->id) }}" method="POST"
                                ...
                                <div class="mb-6 col-md-4">
                                    <div class="form-floating form-floating-outline">
                                        <input
                                            ...
                                            id="customer_id"
                                            name="customer_id"
                                            class="form-control @if($errors->has('customer_id')) is-invalid @endif"
                                            disabled
                                            value="{{ $data->customer->business_name }}"
                                        />
                                ...
                                <div class="mb-6 col-md-4">
                                    <div class="form-floating form-floating-outline">
                                        <input
                                            ...
                                            id="type_contract"
                                            name="type_contract"
                                            class="form-control @if($errors->has('type_contract')) is-invalid @endif"
                                            disabled
