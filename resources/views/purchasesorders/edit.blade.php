@extends('layouts.app')
@section('title', 'Ordenes de Compras - Editar')
@section('css')
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Editar Orden de Compras</h5>
                    ...
                    <div class="card-body">
                        <form id="formPurchase" class="needs-validation" action="{{ route('purchaseorder.update', $data->id) }}" method="POST"
