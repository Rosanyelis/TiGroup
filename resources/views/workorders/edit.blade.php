@extends('layouts.app')
@section('title', 'Ordenes de Trabajo - Editar')
@section('css')
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Editar Orden de Trabajo</h5>

                        <a href="{{ route('workorder.index') }}" class="btn btn-sm btn-secondary"
                        ><i class="ri-arrow-left-line me-1"></i> Regresar</a>
                    </div>

                    <div class="card-body">
                        <form id="formWorkorder" class="needs-validation" action="{{ route('workorder.update', $data->id) }}" method="POST"
                            ...
                            <div class="mb-6 col-md-4">
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        placeholder="Selecione un Cliente">
                                            ...
                                            <option value="{{ $item->id }}" {{ $data->customer_id == $item->id ? 'selected' : '' }}>{{ $item->business_name }}</option>
                                            @endforeach
                                        </select>
        ...
        $.each(oldData, function(index, value) {
            ...
            $("#table_products tbody").append(
                `<tr id="row-`+value.product.code+`">
                    ...
                    <td id="total-`+value.product.code+`">`+value.total+`</td>
                    <td>
