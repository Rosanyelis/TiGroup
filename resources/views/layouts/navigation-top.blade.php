                    ...
                    <li class="dropdown-menu-header border-bottom py-50">
                        <div class="dropdown-header d-flex align-items-center py-2">
                            ...
                            <div class="d-flex align-items-center">
                                <span class="badge rounded-pill bg-label-primary fs-xsmall me-2">{{ $notifications->count() }} Nuevas</span>
                            ...
                            <li
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        <h6 class="mb-1 small text-danger">Tarea <strong>Vencida</strong></h6>
                                        <small class="mb-1 d-block text-body">{{ $notification->task }}</small>
