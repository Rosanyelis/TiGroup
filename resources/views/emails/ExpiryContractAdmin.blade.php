                                                        ...
                                                        <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;"
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="line-height: 160%;"><span
                                                                        ...
                                                                        <strong>Administración TiGroup</strong>.</span></p>
                                                                <p style="line-height: 160%;"><span
                                                                        style="font-size: 18px; line-height: 28.8px;">Dentro
                                                                        de  <strong>15 días</strong> se vence el  <strong>{{ $type_contract }}</strong> del cliente
                                                                          <strong>{{ $customer }}</strong>.
                                                                        El Cliente ya fué notificado.</span></p>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
